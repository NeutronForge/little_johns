...
class GrandChainBlock(settings: Settings) : PillarBlock(settings), Waterloggable {

    override fun getCodec(): MapCodec<GrandChainBlock> = CODEC

    companion object {
        val CODEC: MapCodec<GrandChainBlock> = createCodec(::GrandChainBlock)
